...
public class AngleOfAttackFromAngleToHorizontalCalculator extends Calculator
{
  ...
  {
    // gamma=SIDEWAY_ANGLE, delta=BACKWAY_ANGLE,alpha=APPARENT_WIND_ANGLE
    ...
    double sidewayAngleInRadians = valueSet.getKnownQuantityValue(PhysicalQuantity.SIDEWAY_ANGLE).getValue()*Math.PI/180;
