...
import com.github.thomasfox.boatcalculator.value.FixedPhysicalQuantityValue;
...
public class MaterialConstants
{
  ...
  public static final PhysicalQuantityValue KINEMATIC_VISCOSITY_WATER
     = new FixedPhysicalQuantityValue(PhysicalQuantity.KINEMATIC_VISCOSITY, 0.000001375d);
