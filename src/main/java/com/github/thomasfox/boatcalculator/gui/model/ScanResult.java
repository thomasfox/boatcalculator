...
{
  private final List<ScanResultForSingleQuantity> singleQuantityScanResults = new ArrayList<>();

  private Map<Integer, String> profileNames = new HashMap<>();

  public List<ScanResultForSingleQuantity> getSingleQuantityScanResults()
  {
  ...
  private void writeCsvHeader(Writer fileWriter) throws IOException
  {
    ...
    {
      ScanResultForSingleQuantity firstScanResult = singleQuantityScanResults.get(0);
