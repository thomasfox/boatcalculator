...
public enum PhysicalQuantity
{
  ...
  PARASITIC_DRAG("Parasitärer Widerstand", "N"),
  PARASITIC_DRAG_COEFFICIENT("Widerstandsbeiwert für den parasitären Widerstand", null),
  WAVE_MAKING_DRAG("Wellenwiderstand", "N"),
  WAVE_MAKING_DRAG_COEFFICIENT("Widerstandsbeiwert für den Wellenwiderstand", null),
  ...
  FORCE("Kraft", "N"),
  SUBMERGENCE_DEPTH("Eintauchtiefe", "m"),
  FROUDE_NUMBER_SUMBERGENCE("Froudezahl bzgl. Eintauchtiefe", null),
